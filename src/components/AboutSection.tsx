        ...
        <div className="max-w-6xl mx-auto">
          <div ref={sectionRef} className="grid md:grid-cols-2 gap-12 items-center">
            <div className={`transition-all duration-700 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
              ...
              <h3 className="section-subtitle">IT Visionary & Leader</h3>
              ...
              <div className="space-y-6 text-white/80">
                ...
                <p>
                  My technical expertise spans across enterprise systems administration, development, and infrastructure management, with proficiency in Azure, Google Workspace, Atlassian products, OpSgenie, Aha, GitHub, SQL databases, and automation tools like PowerShell and VisualCron.
                </p>
              </div>
